...
<!-- belle/blog-fullwidth.php   11 Nov 2019 12:46:09 GMT -->
        ...
        <div id="page-content">
            ...
            <div class="page section-header text-center mb-0">
                <div class="page-title">
                    <div class="wrapper">
                        <h1 class="page-width">Blog Fullwidth</h1>
                    </div>
                </div>
            </div>
            <!--End Page Title-->
            <div class="bredcrumbWrap">
                <div class="container breadcrumbs">
                    <a href="index.php" title="Back to the home page">Home</a><span aria-hidden="true">›</span><span>Blog Fullwidth</span>
                </div>
            </div>
            <div class="container">
                <div class="row">
