...
<!-- belle/home4-fullwidth.php   11 Nov 2019 12:24:38 GMT -->
                            ...
                            <div class="col-6 col-sm-6 col-md-3 col-lg-3 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Floral Sleeveless Dress</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-3 col-lg-3 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Lexie Shirt</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-3 col-lg-3 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">A-Line Jacket</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
...
<!-- belle/home4-fullwidth.php   11 Nov 2019 12:25:38 GMT -->
