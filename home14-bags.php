...
<!-- belle/home14-bags.php   11 Nov 2019 12:35:19 GMT -->
        ...
        <div id="page-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="inner">
                                    <a href="#">
                                        <img data-src="assets/images/slideshow-banners/home14-bags-bnr1.jpg" src="assets/images/slideshow-banners/home14-bags-bnr1.jpg" alt="" title="" class="blur-up lazyload" />
                                    </a>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                            <p>
                                <a href="#">
                                    <img data-src="assets/images/collection/home14-bags-sm-banner1.jpg" src="assets/images/collection/home14-bags-sm-banner1.jpg" alt="New in !" class="blur-up lazyload">
                                </a>
                            </p>
                            <h3 class="h4"><a href="#">New in !</a></h3>
                            <div class="rte-setting">
                                <p>Wallet and small leaather goods</p>
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                            <p>
                                <a href="#">
                                    <img data-src="assets/images/collection/home14-bags-sm-banner2.jpg" src="assets/images/collection/home14-bags-sm-banner2.jpg" alt="My Valentine" class="blur-up lazyload">
                                </a>
                            </p>
                            <h3 class="h4"><a href="#">My Valentine</a></h3>
                            <div class="rte-setting">
                                <p>Gift ideas for him to personalize</p>
                            </div>
                            <a href="#" class="btn no-border">Discover</a>
                        </div>
                        <!--End Featured Item-->
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                            <p>
                                <a href="#">
                                    <img data-src="assets/images/collection/home14-bags-sm-banner3.jpg" src="assets/images/collection/home14-bags-sm-banner3.jpg" alt="Gift ideas" class="blur-up lazyload">
                                </a>
                            </p>
                            <h3 class="h4"><a href="#">Gift ideas</a></h3>
                            <div class="rte-setting">
                                <p>An exceptional gift</p>
                            </div>
                            <a href="#" class="btn no-border">Discover</a>
                        </div>
                        <!--End Featured Item-->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 text-center">
                            <p>
                                <a href="#">
                                    <img data-src="assets/images/collection/home14-bags-sm-banner4.jpg" src="assets/images/collection/home14-bags-sm-banner4.jpg" alt="ICONICS Bag" class="blur-up lazyload">
                                </a>
                            </p>
                            <h3 class="h4"><a href="#">ICONICS Bag</a></h3>
                            <div class="rte-setting">
                                <p>Timeless and modern the must-have Lancel</p>
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-6 text-center">
                            <p>
                                <a href="#">
                                    <img data-src="assets/images/collection/home14-bags-sm-banner5.jpg" src="assets/images/collection/home14-bags-sm-banner5.jpg" alt="Pop around the world" class="blur-up lazyload">
                                </a>
                            </p>
                            <h3 class="h4"><a href="#">Pop around the world</a></h3>
                            <div class="rte-setting">
                                <p>Soft and lightweight material wallets for women</p>
                            </div>
                            <a href="#" class="btn no-border">Discover More</a>
                        </div>
                        <!--End Featured Item-->
            ...
            <div class="section">
                <div class="hero hero--small hero__overlay bg-size">
                    <img class="bg-img blur-up" src="assets/images/parallax-banners/home14-bags-parallax.jpg" alt="" />
                            ...
                            <div class="productSlider grid-products grid-products-hover-btn">
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img1.jpg" src="assets/images/product-images/bags-p-img1.jpg" alt="image" title="product">
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img1-1.jpg" src="assets/images/product-images/bags-p-img1-1.jpg" alt="image" title="product">
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Woven Oversized Tote in Red Stripe</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img2.jpg" src="assets/images/product-images/bags-p-img2.jpg" alt="image" title="product">
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img2-1.jpg" src="assets/images/product-images/bags-p-img2-1.jpg" alt="image" title="product">
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Wool Shoulder Pouch in Black/White</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img3.jpg" src="assets/images/product-images/bags-p-img3.jpg" alt="image" title="product">
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img3-1.jpg" src="assets/images/product-images/bags-p-img3-1.jpg" alt="image" title="product">
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Tenda Bag</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img4.jpg" src="assets/images/product-images/bags-p-img4.jpg" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img4-1.jpg" src="assets/images/product-images/bags-p-img4-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Ink Splatter Shoulder Bag in Mustard/Blue</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img5.jpg" src="assets/images/product-images/bags-p-img5.jpg" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img5-1.jpg" src="assets/images/product-images/bags-p-img5-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Roxanne Leather Clutch in Black</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img6.jpg" src="assets/images/product-images/bags-p-img6.jpg" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img6-1.jpg" src="assets/images/product-images/bags-p-img6-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Pretty Grooming Bag</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img7.jpg" src="assets/images/product-images/bags-p-img7.jpg" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img7-1.jpg" src="assets/images/product-images/bags-p-img7-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                    ...
                                    <div class="product-details text-center">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-1.php">Oscar Luggage Tag in Rose</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                                ...
                                <div class="col-12 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="product-layout-1.php" class="grid-view-item__link">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="assets/images/product-images/bags-p-img8.jpg" src="assets/images/product-images/bags-p-img8.jpg" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="assets/images/product-images/bags-p-img8-1.jpg" src="assets/images/product-images/bags-p-img8-1.jpg" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
...
<!-- belle/home14-bags.php   11 Nov 2019 12:37:31 GMT -->
