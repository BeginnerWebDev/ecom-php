...
<!-- belle/product-with-image-swatch.php   11 Nov 2019 12:43:14 GMT -->

<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Product with Image Swatch &ndash; Belle Multipurpose Bootstrap 4 Template</title>
            ...
            <div id="MainContent" class="main-content" role="main">
                ...
                <div class="bredcrumbWrap">
                    <div class="container breadcrumbs" role="navigation" aria-label="breadcrumbs">
                        <a href="index.php" title="Back to the home page">Home</a><span aria-hidden="true">›</span><span>Product with Image Swatch</span>
                    </div>
                </div>
                <!--End Breadcrumb-->
                        ...
                        <div class="row">
                                ...
                                <div class="product-details-img product-single__photos bottom">
                                    <div class="zoompro-wrap product-zoom-right pl-20">
                                        <div class="zoompro-span">
                                            <img class="blur-up lazyload zoompro" data-zoom-image="assets/images/product-detail-page/product-with-image-swatch1.jpg" alt="" src="assets/images/product-detail-page/product-with-image-swatch1.jpg" />
                                        </div>
                                    ...
                                    <div class="product-thumb product-thumb-1">
                                        <div id="gallery" class="product-dec-slider-1 product-tab-left">
                                            <a data-image="assets/images/product-detail-page/product-with-image-swatch1.jpg" data-zoom-image="assets/images/product-detail-page/product-with-image-swatch1.jpg" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-image-swatch1.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-detail-page/product-with-image-swatch2.jpg" data-zoom-image="assets/images/product-detail-page/product-with-image-swatch2.jpg" class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-image-swatch2.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-detail-page/product-with-image-swatch3.jpg" data-zoom-image="assets/images/product-detail-page/product-with-image-swatch3.jpg" class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-image-swatch3.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-detail-page/product-with-image-swatch4.jpg" data-zoom-image="assets/images/product-detail-page/product-with-image-swatch4.jpg" class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-image-swatch4.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-detail-page/product-with-image-swatch5.jpg" data-zoom-image="assets/images/product-detail-page/product-with-image-swatch5.jpg" class="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-image-swatch5.jpg" alt="" />
                                            </a>
                                            <a data-image="assets/images/product-detail-page/product-with-image-swatch6.jpg" data-zoom-image="assets/images/product-detail-page/product-with-image-swatch6.jpg" class="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-image-swatch6.jpg" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="lightboximages">
                                        <a href="assets/images/product-detail-page/product-with-image-swatch1.jpg" data-size="1462x2048"></a>
                                        <a href="assets/images/product-detail-page/product-with-image-swatch2.jpg" data-size="1462x2048"></a>
                                        <a href="assets/images/product-detail-page/product-with-image-swatch3.jpg" data-size="1462x2048"></a>
                                        <a href="assets/images/product-detail-page/product-with-image-swatch4.jpg" data-size="1462x2048"></a>
                                        <a href="assets/images/product-detail-page/product-with-image-swatch5.jpg" data-size="1462x2048"></a>
                                        <a href="assets/images/product-detail-page/product-with-image-swatch6.jpg" data-size="1462x2048"></a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product-single__meta">
                                    <h1 class="product-single__title">Product with Image Swatch</h1>
                                        ...
                                        <div class="swatch clearfix swatch-1 option2" data-option-index="1">
                                            <div class="product-form__item">
                                                ...
                                                <div data-value="X-Small" class="swatch-element x-small available">
                                                    <input class="swatchInput" id="swatch-1-x-small" type="radio" name="option-1" value="X-Small"><label class="swatchLbl small" for="swatch-1-x-small" title="X-Small">X-Small</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                            <div class="product-form__item">
                                                ...
                                                <div data-value="aqua" class="swatch-element color aqua available">
                                                    ...
                                                    <label class="swatchLbl color large" for="swatch-0-aqua" style="background-image:url(assets/images/swatches/color-img1.jpg);" title="aqua"></label>
                                                </div>
                                                <div data-value="aqua" class="swatch-element color aqua available">
                                                    <input class="swatchInput" id="swatch-1-aqua" type="radio" name="option-1" value="aqua">
                                                    <label class="swatchLbl color large" for="swatch-1-aqua" style="background-image:url(assets/images/swatches/color-img2.jpg);" title="aqua"></label>
                                                </div>
                                                <div data-value="aqua" class="swatch-element color aqua available">
                                                    <input class="swatchInput" id="swatch-2-aqua" type="radio" name="option-2" value="aqua">
                                                    <label class="swatchLbl color large" for="swatch-2-aqua" style="background-image:url(assets/images/swatches/color-img3.jpg);" title="aqua"></label>
                                                </div>
                                            </div>
                                        </div>
...
<!-- belle/product-with-image-swatch.php   11 Nov 2019 12:43:47 GMT -->
