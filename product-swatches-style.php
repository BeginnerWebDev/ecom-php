...
<!-- belle/product-swatches-style.php   11 Nov 2019 12:41:10 GMT -->
            ...
            <div class="collection-header">
                <div class="collection-hero">
                    ...
                    <div class="collection-hero__title-wrapper">
                        <h1 class="collection-hero__title page-width">Product Swatches Styles</h1>
                    </div>
                </div>
            </div>
                            ...
                            <div class="grid-products grid--view-items">
                                <div class="row">
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                        ...
                                        <ul class="swatches color-style color-style1">
                                            <li class="swatch rounded">
                                                ...
                                                <label class="color" title="Black"><span class="black"></span></label>
                                            </li>
                                            <li class="swatch rounded">
                                                <input type="checkbox" value="white">
                                                <label class="color" title="White"><span class="white"></span></label>
                                            </li>
                                            <li class="swatch rounded">
                                                <input type="checkbox" value="red">
                                                <label class="color" title="Red"><span class="red"></span></label>
                                            </li>
                                            <li class="swatch rounded">
                                                <input type="checkbox" value="blue">
                                                <label class="color" title="Blue"><span class="blue"></span></label>
                                            </li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    ...
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                        ...
                                        <!-- Variant -->
                                        <ul class="swatches">
                                            <li class="swatch medium square"><img src="assets/images/product-images/variant1.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/product-images/variant2.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/product-images/variant3.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/product-images/variant4.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/product-images/variant5.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/product-images/variant6.jpg" alt="image" /></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                        ...
                                        <!-- Variant -->
                                        <ul class="swatches">
                                            <li class="swatch medium radius"><img src="assets/images/product-images/variant1.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/product-images/variant2.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/product-images/variant3.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/product-images/variant4.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/product-images/variant5.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/product-images/variant6.jpg" alt="image" /></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                        ...
                                        <!-- Variant -->
                                        <ul class="swatches">
                                            <li class="swatch medium square"><img src="assets/images/swatches/color-img1.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/swatches/color-img2.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/swatches/color-img3.jpg" alt="image" /></li>
                                            <li class="swatch medium square"><img src="assets/images/swatches/color-img4.jpg" alt="image" /></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                        ...
                                        <!-- Variant -->
                                        <ul class="swatches">
                                            <li class="swatch medium rounded"><img src="assets/images/swatches/color-img1.jpg" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="assets/images/swatches/color-img2.jpg" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="assets/images/swatches/color-img3.jpg" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="assets/images/swatches/color-img4.jpg" alt="image" /></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                        ...
                                        <!-- Variant -->
                                        <ul class="swatches">
                                            <li class="swatch medium radius"><img src="assets/images/swatches/color-img1.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/swatches/color-img2.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/swatches/color-img3.jpg" alt="image" /></li>
                                            <li class="swatch medium radius"><img src="assets/images/swatches/color-img4.jpg" alt="image" /></li>
                                        </ul>
                                        <!-- End Variant -->
                                    </div>
                                </div>
...
<!-- belle/product-swatches-style.php   11 Nov 2019 12:41:14 GMT -->
