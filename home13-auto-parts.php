...
<!-- belle/home13-auto-parts.php   11 Nov 2019 12:33:20 GMT -->
                                                ...
                                                <ul class="grid">
                                                    ...
                                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" class="site-nav lvl-1">Home Group 2</a>
                                                        <ul class="subLinks">
                                                            ...
                                                            <li class="lvl-2"><a href="#" class="site-nav lvl-2">Home 13 - Auto Parts</a></li>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="flex top-info-bar">
                            <div class="flex-item">
                                <img src="assets/images/truck-mini.png" alt=""> Free Shipping on all orders over $100.
                            </div>
                            <div class="flex-item">
                                <img src="assets/images/check.png" alt=""> Worldwide Delivery and same day dispatch.
                            </div>
                            <div class="flex-item">
                                <img src="assets/images/return-mini.png" alt=""> Extended Returns Until 10th February
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="site-nav">Home Group 2<i class="anm anm-plus-l"></i></a>
                            <ul>
                                ...
                                <li><a href="#" class="site-nav">Home 13 - Auto Parts</a></li>
        ...
        <div id="page-content">
            ...
            <div class="section featured-content pb-0">
                <div class="container">
                    ...
                    <div class="row list-items">
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                            <img class="blur-up lazyload" data-src="assets/images/return.png" src="assets/images/return.png" alt="Easy Returns" title="Easy Returns" />
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                            <img class="blur-up lazyload" data-src="assets/images/reliable.png" src="assets/images/reliable.png" alt="Reliability" title="Reliability" />
                        ...
                        <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                            <img class="blur-up lazyload" data-src="assets/images/lock.png" src="assets/images/lock.png" alt="Security" title="Security" />
                    ...
                    <div class="collection-grid-4item">
                        <div class="collection-grid-item">
                            <a href="collection-page.php" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/home13-autoparts1.jpg" src="assets/images/collection/home13-autoparts1.jpg" alt="Performance Parts" class="blur-up lazyload" />
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.php" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/home13-autoparts5.jpg" src="assets/images/collection/home13-autoparts5.jpg" alt="Shoes" class="blur-up lazyload" />
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.php" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/home13-autoparts2.jpg" src="assets/images/collection/home13-autoparts2.jpg" alt="Body Parts" class="blur-up lazyload" />
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.php" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/home13-autoparts4.jpg" src="assets/images/collection/home13-autoparts4.jpg" alt="Accessories" class="blur-up lazyload" />
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item blur-up lazyloaded">
                            <a href="collection-page.php" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/home13-autoparts3.jpg" src="assets/images/collection/home13-autoparts3.jpg" alt="Tools &amp; Equipment" class="blur-up lazyload" />
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.php" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/home13-autoparts6.jpg" src="assets/images/collection/home13-autoparts6.jpg" alt="Tools" class="blur-up lazyload" />
                                <div class="collection-grid-item__title-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="categories-list-items">
                        <div class="row">
                            <div class="col-12">
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img1.jpg" src="assets/images/autoparts/categories-img1.jpg" alt="Tools & Garage" title="Tools & Garage"></a>
                                ...
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img2.jpg" src="assets/images/autoparts/categories-img2.jpg" alt="Exterior Accessories" title="Exterior Accessories"></a>
                                ...
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img3.jpg" src="assets/images/autoparts/categories-img3.jpg" alt="Body Parts &amp; Mirrors" title="Body Parts &amp; Mirrors"></a>
                                ...
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img4.jpg" src="assets/images/autoparts/categories-img4.jpg" alt="Interior Accessories" title="Interior Accessories"></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img5.jpg" src="assets/images/autoparts/categories-img5.jpg" alt="Headlights &amp; Lighting" title="Headlights &amp; Lighting"></a>
                                ...
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img6.jpg" src="assets/images/autoparts/categories-img6.jpg" alt="Exhaust System" title="Exhaust System"></a>
                                ...
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img7.jpg" src="assets/images/autoparts/categories-img7.jpg" alt="Brakes, Suspension &amp; Steering" title="Brakes, Suspension &amp; Steering"></a>
                                ...
                                <div class="categories-item">
                                    <a href="#" class="thumb"><img class="primary blur-up lazyload" data-src="assets/images/autoparts/categories-img8.jpg" src="assets/images/autoparts/categories-img8.jpg" alt="Engine &amp; Drivetrain" title="Engine &amp; Drivetrain"></a>
            ...
            <div class="section">
                <div class="hero hero--large hero__overlay bg-size">
                    <img class="bg-img blur-up" src="assets/images/parallax-banners/home13-car-parts.jpg" alt="" />
                        ...
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-3 col-lg-3 item">
                                ...
                                <div class="product-image">
                                    <!-- start product image -->
                                    <a href="product-layout-1.php" class="grid-view-item__link">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img1.jpg" src="assets/images/product-images/auto-parts-p-img1.jpg" alt="image" title="product">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img1-1.jpg" src="assets/images/product-images/auto-parts-p-img1-1.jpg" alt="image" title="product">
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
                                ...
                                <div class="product-details text-center">
                                    ...
                                    <div class="product-name">
                                        <a href="product-layout-1.php">8 Tons Powerful Car Auto Tow Rope Trailer Rope</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-3 col-lg-3 item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout-1.php" class="grid-view-item__link">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img2.jpg" src="assets/images/product-images/auto-parts-p-img2.jpg" alt="image" title="product">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img2-1.jpg" src="assets/images/product-images/auto-parts-p-img2-1.jpg" alt="image" title="product">
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
                                ...
                                <div class="product-details text-center">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-layout-1.php">Air Pressure Gauge Heavy Duty Best For Car</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-3 col-lg-3 item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout-1.php" class="grid-view-item__link">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img3.jpg" src="assets/images/product-images/auto-parts-p-img3.jpg" alt="image" title="product">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img3-1.jpg" src="assets/images/product-images/auto-parts-p-img3-1.jpg" alt="image" title="product">
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
                                ...
                                <div class="product-details text-center">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-layout-1.php">Air Pump MTB Motorcycle Car Basketball Bike</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                            ...
                            <div class="col-6 col-sm-6 col-md-3 col-lg-3 item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout-1.php" class="grid-view-item__link">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img4.jpg" src="assets/images/product-images/auto-parts-p-img4.jpg" alt="image" title="product" />
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="assets/images/product-images/auto-parts-p-img4-1.jpg" src="assets/images/product-images/auto-parts-p-img4-1.jpg" alt="image" title="product" />
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
                                ...
                                <div class="product-details text-center">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-layout-1.php">Honeywell Move Pure Car Air Purifier</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
...
<!-- belle/home13-auto-parts.php   11 Nov 2019 12:35:17 GMT -->
