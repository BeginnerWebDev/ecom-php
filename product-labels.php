...
<!-- belle/product-labels.php   11 Nov 2019 12:41:09 GMT -->
            ...
            <div class="collection-header">
                <div class="collection-hero">
                    ...
                    <div class="collection-hero__title-wrapper">
                        <h1 class="collection-hero__title page-width">Product Labels</h1>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a href="#">
                                                ...
                                                <!-- End hover image -->
                                                <!-- product label -->
                                                <div class="product-labels rounded"><span class="lbl pr-label2">Hot</span> <span class="lbl on-sale">Sale</span></div>
                                                <!-- End product label -->
                                            </a>
                                            <!-- end product image -->
                                    ...
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a href="#">
                                                ...
                                                <!-- End hover image -->
                                                <!-- product label -->
                                                <div class="product-labels radius"><span class="lbl pr-label1">new</span> <span class="lbl on-sale">Sale</span></div>
                                                <!-- End product label -->
                                            </a>
                                            <!-- end product image -->
                                    ...
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a href="#">
                                                ...
                                                <!-- End hover image -->
                                                <!-- product label -->
                                                <div class="product-labels radius"><span class="lbl pr-label1">Trending</span> <span class="lbl on-sale">Best seller</span></div>
                                                <!-- End product label -->
                                            </a>
                                            <!-- end product image -->
