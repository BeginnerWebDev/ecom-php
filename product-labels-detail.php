...
<!-- belle/product-labels-detail.php   11 Nov 2019 12:44:03 GMT -->

<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Product Labels &ndash; Belle Multipurpose Bootstrap 4 Template</title>
            ...
            <div id="MainContent" class="main-content" role="main">
                ...
                <div class="bredcrumbWrap">
                    <div class="container breadcrumbs">
                        <a href="index.php" title="Back to the home page">Home</a><span aria-hidden="true">›</span><span>Product Labels</span>
                    </div>
                </div>
                <!--End Breadcrumb-->
                        ...
                        <div class="row">
                                ...
                                <div class="product-details-img">
                                    <div class="product-thumb">
                                        <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                            <a data-image="assets/images/product-detail-page/product-labels1.jpg" data-zoom-image="assets/images/product-detail-page/product-labels1.jpg" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload" src="assets/images/product-detail-page/product-labels1.jpg" alt="" />
                                            </a>
                                    ...
                                    <div class="zoompro-wrap product-zoom-right pl-20">
                                        <div class="zoompro-span">
                                            <img class="zoompro blur-up lazyload" data-zoom-image="assets/images/product-detail-page/product-labels1.jpg" alt="" src="assets/images/product-detail-page/product-labels1.jpg" />
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product-single__meta">
                                    <h1 class="product-single__title">Product Labels</h1>
...
<!-- belle/product-labels-detail.php   11 Nov 2019 12:44:30 GMT -->
