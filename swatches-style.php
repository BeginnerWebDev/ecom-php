...
<!-- belle/swatches-style.php   11 Nov 2019 12:43:58 GMT -->
        ...
        <div id="page-content">
            ...
            <div class="page section-header text-center">
                <div class="page-title">
                    <div class="wrapper">
                        <h1 class="page-width">Swatches Style</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                        <img src="assets/images/diffrent-style-swatches.jpg" alt="" title="" />
                    </div>
                    <!--End Main Content-->
                </div>
            </div>
...
<!-- belle/swatches-style.php   11 Nov 2019 12:43:59 GMT -->
