...
<!-- belle/home7-shoes.php   11 Nov 2019 12:28:16 GMT -->
                        ...
                        <div class="productSlider-style1">
                            <div class="col-12 item grid-view-item style2">
                                <div class="grid-view_image">
                                    <!-- start product image -->
                                    <a href="product-layout-2.php" class="grid-view-item__link">
                                        <!-- image -->
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        ...
                                        <div class="product-name">
                                            <a href="product-layout-2.php">Camoscio Zip Heel</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                            ...
                            <div class="col-12 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-2.php">Camoscio Heel</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                            ...
                            <div class="col-12 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-2.php">Aqualina Sandal</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                            ...
                            <div class="col-12 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-2.php">Glove Heel</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
                            ...
                            <div class="col-12 item grid-view-item style2">
                                <div class="grid-view_image">
                                    ...
                                    <div class="product-details hoverDetails text-center mobile">
                                        <!-- product name -->
                                        <div class="product-name">
                                            <a href="product-layout-2.php">Avalon Sandal</a>
                                        </div>
                                        <!-- End product name -->
                                        <!-- product price -->
                                        <div class="product-price">
...
<!-- belle/home7-shoes.php   11 Nov 2019 12:30:10 GMT -->
