...
<!-- belle/product-with-dropdown.php   11 Nov 2019 12:43:47 GMT -->

<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <meta http-equiv="x-ua-compatible" content="ie=edge">
  <title>Product with Dropdown &ndash; Belle Multipurpose Bootstrap 4 Template</title>
      ...
      <div id="MainContent" class="main-content" role="main">
        ...
        <div class="bredcrumbWrap">
          <div class="container breadcrumbs" role="navigation" aria-label="breadcrumbs">
            <a href="index.php" title="Back to the home page">Home</a><span aria-hidden="true">›</span><span>Product with Dropdown</span>
          </div>
        </div>
        <!--End Breadcrumb-->
                ...
                <div class="product-details-img">
                  <div class="zoompro-wrap product-zoom-right pl-20">
                    <div class="zoompro-span">
                      <img class="blur-up lazyload zoompro" data-zoom-image="assets/images/product-detail-page/product-with-dropdown1.jpg" alt="" src="assets/images/product-detail-page/product-with-dropdown1.jpg" />
                    </div>
                  ...
                  <div class="product-thumb">
                    <div id="gallery" class="product-dec-slider-2 product-tab-left">
                      <a data-image="assets/images/product-detail-page/product-with-dropdown1.jpg" data-zoom-image="assets/images/product-detail-page/product-with-dropdown1.jpg" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                        <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-dropdown1.jpg" alt="" />
                      </a>
                      <a data-image="assets/images/product-detail-page/product-with-dropdown2.jpg" data-zoom-image="assets/images/product-detail-page/product-with-dropdown2.jpg" class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1">
                        <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-dropdown2.jpg" alt="" />
                      </a>
                      <a data-image="assets/images/product-detail-page/product-with-dropdown3.jpg" data-zoom-image="assets/images/product-detail-page/product-with-dropdown2.jpg" class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1">
                        <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-dropdown3.jpg" alt="" />
                      </a>
                      <a data-image="assets/images/product-detail-page/product-with-dropdown4.jpg" data-zoom-image="assets/images/product-detail-page/product-with-dropdown4.jpg" class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1">
                        <img class="blur-up lazyload" src="assets/images/product-detail-page/product-with-dropdown4.jpg" alt="" />
                      </a>
                ...
                <div class="prSidebar sidebar-product">
                  ...
                  <div class="related-product grid-products clearfix">
                    ...
                    <div class="grid">
                        ...
                        <div class="mini-list-item">
                          <div class="mini-view_image">
                            <a class="grid-view-item__link" href="#">
                              <img class="grid-view-item__image" src="assets/images/product-images/product-image21.jpg" alt="">
                            </a>
                          </div>
                          <div class="details">
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image18.jpg" alt=""></a> </div>
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image22.jpg" alt=""></a> </div>
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image23.jpg" alt=""></a> </div>
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"><a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image25.jpg" alt=""></a> </div>
                    ...
                    <div class="grid">
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image">
                            <a class="grid-view-item__link" href="#">
                              <img class="grid-view-item__image" src="assets/images/product-images/product-image1.jpg" alt="">
                            </a>
                          </div>
                          <div class="details">
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image42.jpg" alt=""></a> </div>
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image40.jpg" alt=""></a> </div>
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"> <a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image46.jpg" alt=""></a> </div>
                      ...
                      <div class="grid__item">
                        <div class="mini-list-item">
                          <div class="mini-view_image"><a class="grid-view-item__link" href="#"><img class="grid-view-item__image" src="assets/images/product-images/product-image45.jpg" alt=""></a> </div>
...
<!-- belle/product-with-dropdown.php   11 Nov 2019 12:43:57 GMT -->
