...
<!-- belle/home8-jewellery.php   11 Nov 2019 12:30:11 GMT -->
                    ...
                    <div class="productSlider-style2 grid-products">
                        <div class="col-12 item">
                            ...
                            <div class="product-details text-center">
                                ...
                                <div class="product-name">
                                    <a href="product-layout-1.php">Silver Designer Pendant Set</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout-1.php">Cardinal Necklace Set for Women</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout-1.php">Posh Diamond Bracelet</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout-1.php">Eye-Catchy Fancy Bracelet</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="product-layout-1.php">Tibetan Stone Beads Necklace Set</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
...
<!-- belle/home8-jewellery.php   11 Nov 2019 12:31:16 GMT -->
